<template>
    ...
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <form class="chat-form rounded-pill bg-dark" data-emoji-form=""
              action="api/messages" @submit.prevent="sendMessage()" method="post">
            <input type="hidden" name="_token" :value="this.$root.csrf_token">
            <input name="conversation_id" type="hidden" :value="this.conversation.id">
            <div class="row align-items-center gx-0">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea v-model="message" name="message" class="form-control px-0"
