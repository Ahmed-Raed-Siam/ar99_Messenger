jQuery(document).ready(function ($) {
    ...
    $('#nov2021SaleAlert .close').click(function (e) {
        e.preventDefault();
        Cookies.set('nov2021SaleAlert', 'closed', {expires: 30});
    });

    if (Cookies.get('nov2021SaleAlert') !== 'closed') {
        $('#nov2021SaleAlert').removeClass('d-none');
    }
