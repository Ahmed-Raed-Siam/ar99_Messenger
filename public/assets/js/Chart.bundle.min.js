    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            function a(t) {
                if (t) {
                    var e = /^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/,
                        n = t.match(e);
                    if (n) {
                        var i = parseFloat(n[4]), a = y(parseInt(n[1]), 0, 360), r = y(parseFloat(n[2]), 0, 100),
                            o = y(parseFloat(n[3]), 0, 100), s = y(isNaN(i) ? 1 : i, 0, 1);
                        return [a, r, o, s]
                    }
                }
            }
            ...
            !function (e, a) {
                ...
                function m(t) {
                    if (null == t._isValid) {
                        var e = p(t), n = wi.call(e.parsedDateParts, function (t) {
                                return null != t
                            }),
                ...
                function y(t, e) {
                    var n, i, a;
                    if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), s(e._i) || (t._i = e._i), s(e._f) || (t._f = e._f), s(e._l) || (t._l = e._l), s(e._strict) || (t._strict = e._strict), s(e._tzm) || (t._tzm = e._tzm), s(e._isUTC) || (t._isUTC = e._isUTC), s(e._offset) || (t._offset = e._offset), s(e._pf) || (t._pf = p(e)), s(e._locale) || (t._locale = e._locale), Mi.length > 0) for (n = 0; n < Mi.length; n++) i = Mi[n], a = e[i], s(a) || (t[i] = a);
                    return t
                }
                ...
                function kt(t, e, n) {
                    var i = 7 + e - n, a = (7 + _t(t, 0, i).getUTCDay() - e) % 7;
                    return -a + i - 1
                }

                function wt(t, e, n, i, a) {
                    var r, o, s = (7 + n - i) % 7, l = kt(t, i, a), u = 1 + 7 * (e - 1) + s + l;
                ...
                function Mt(t, e, n) {
                    var i, a, r = kt(t.year(), e, n), o = Math.floor((t.dayOfYear() - r - 1) / 7) + 1;
                ...
                function oe(t) {
                    var e, n, i, a, r, o, s = t._i, l = Va.exec(s) || Wa.exec(s);
                    if (l) {
                        for (p(t).iso = !0, e = 0, n = za.length; e < n; e++) if (za[e][1].exec(l[1])) {
                            a = za[e][0], i = za[e][2] !== !1;
                            break
                        }
                        if (null == a) return void (t._isValid = !1);
                        if (l[3]) {
                            for (e = 0, n = Na.length; e < n; e++) if (Na[e][1].exec(l[3])) {
                                r = (l[2] || " ") + Na[e][0];
                                break
                            }
                ...
                function se(t) {
                    ...
                    if (e = t._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), n = Ea.exec(e)) {
                        if (i = n[1] ? "ddd" + (5 === n[1].length ? ", " : " ") : "", a = "D MMM " + (n[2].length > 10 ? "YYYY " : "YY "), r = "HH:mm" + (n[4] ? ":ss" : ""), n[1]) {
                            var c = new Date(n[2]), h = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][c.getDay()];
                ...
                function Se(t) {
                    for (var e in t) if (Ga.indexOf(e) === -1 || null != t[e] && isNaN(t[e])) return !1;
                    for (var n = !1, i = 0; i < Ga.length; ++i) if (t[Ga[i]]) {
                        if (n) return !1;
                ...
                function Pe(t) {
                    var e = z(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || 0,
                ...
                function Fe(t, e) {
                    ...
                    var i = n[n.length - 1] || [], a = (i + "").match(qa) || ["-", 0, 0], r = +(60 * a[1]) + k(a[2]);
                ...
                function Ke(e, n, i, a) {
                    var r = n._milliseconds, o = Ie(n._days), s = Ie(n._months);
                ...
                function $e(e, n) {
                    var i = e || _e(), a = Oe(i, this).startOf("day"), r = t.calendarFormat(this, a) || "sameElse",
                ...
                function Yn(t, e, n, i, a) {
                    var r = wt(t, e, n, i, a), o = _t(r.year, 0, r.dayOfYear);
                ...
                function mi(t, e, n) {
                    var i = Ge(t).abs(), a = kr(i.as("s")), r = kr(i.as("m")), o = kr(i.as("h")), s = kr(i.as("d")),
                        l = kr(i.as("M")), u = kr(i.as("y")),
                ...
                function bi(t) {
                    ...
                    var e = this.localeData(), n = mi(this, !t, e);
                    return t && (n = e.pastFuture(+this, n)), e.postformat(n)
                }

                function xi() {
                    if (!this.isValid()) return this.localeData().invalidDate();
                    var t, e, n, i = Mr(this._milliseconds) / 1e3, a = Mr(this._days), r = Mr(this._months);
                ...
                var wi = ki, Mi = t.momentProperties = [], Si = !1, Di = {};
                ...
                var Pi, Ti = Ci, Ii = {
                    ...
                    }, Fi = "Invalid date", Oi = "%d", Ri = /\d{1,2}/, Li = {
                        future: "in %s",
                        past: "%s ago",
                        s: "a few seconds",
                        ss: "%d seconds",
                    ...
                    zi = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Ni = {}, Bi = {}, Ei = /\d/, Hi = /\d\d/,
                    ji = /\d{3}/, Ui = /\d{4}/, Gi = /[+-]?\d{6}/, qi = /\d\d?/, Zi = /\d\d\d\d?/, Xi = /\d\d\d\d\d\d?/,
                    Ji = /\d{1,3}/, Ki = /\d{1,4}/, Qi = /[+-]?\d{1,6}/, $i = /\d+/, ta = /[+-]?\d+/,
                    ea = /Z|[+-]\d\d:?\d\d/gi, na = /Z|[+-]\d\d(?::?\d\d)?/gi, ia = /[+-]?\d+(\.\d{1,3})?/,
                    aa = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
                    ra = {}, oa = {}, sa = 0, la = 1, ua = 2, da = 3, ca = 4, ha = 5, fa = 6, ga = 7, pa = 8;
                ...
                var va = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                    ...
                    ba = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), xa = aa, _a = aa;
                Z("Y", 0, 0, function () {
                    var t = this.year();
                    return t <= 9999 ? "" + t : "+" + t
                }), Z(0, ["YY", 2], 0, function () {
                ...
                var Ma = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                    Sa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Da = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Ca = aa,
                    Pa = aa, Ta = aa;
                ...
                var Ia, Aa = /[ap]\.?m?\.?/i, Fa = E("Hours", !0), Oa = {
                        calendar: Ii,
                        longDateFormat: Ai,
                        invalidDate: Fi,
                        ordinal: Oi,
                ...
                var Ja = Je(1, "add"), Ka = Je(-1, "subtract");
                ...
                var or = Math.abs, sr = ci("ms"), lr = ci("s"), ur = ci("m"), dr = ci("h"), cr = ci("d"), hr = ci("w"),
                    fr = ci("M"), gr = ci("y"), pr = fi("milliseconds"), mr = fi("seconds"), vr = fi("minutes"),
                    yr = fi("hours"), br = fi("days"), xr = fi("months"), _r = fi("years"), kr = Math.round,
                    wr = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11}, Mr = Math.abs, Sr = Pe.prototype;
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    dataElementType: t.elements.Rectangle, initialize: function () {
                        ...
                        var a = this, r = a.chart, o = a.getMeta(), s = a.getDataset(), l = t.custom || {},
                        ...
                        var e, n, i = this, a = i.chart, r = i.getIndexScale(), o = r.options.stacked,
                            s = void 0 === t ? a.data.datasets.length : t + 1, l = [];
                        ...
                        var t = this, n = t.getIndexScale(), i = n.options, a = t.getStackCount(),
                            ...
                            s = o * i.categoryPercentage, l = s / a, u = l * i.barPercentage;
                        ...
                        var t, n = this, i = n.chart, a = n.getMeta().data, r = n.getDataset(), o = a.length, s = 0;
                ...
                n.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], s = r.data[a],
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        var n = this, i = n.chart, a = i.chartArea, r = i.options, o = r.elements.arc,
                            s = a.right - a.left - o.borderWidth, l = a.bottom - a.top - o.borderWidth,
                            u = Math.min(s, l), d = {x: 0, y: 0}, c = n.getMeta(), h = r.cutoutPercentage,
                            f = r.circumference;
                        if (f < 2 * Math.PI) {
                            ...
                            u = Math.min(s / S.width, l / S.height), d = {x: (M.x + w.x) * -.5, y: (M.y + w.y) * -.5}
                        }
                        ...
                        var a = this, r = a.chart, o = r.chartArea, s = r.options, l = s.animation,
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    datasetElementType: t.elements.Line, dataElementType: t.elements.Point, update: function (t) {
                        ...
                        var a, r, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index,
                        ...
                        var n = this, i = n.chart, a = n.getMeta(), r = a.data || [], o = i.chartArea, s = r.length,
                            l = 0;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, update: function (t) {
                        ...
                        var y = s.startAngle, b = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[n]),
                            x = y + h * p, _ = x + (t.hidden ? 0 : h),
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = t.custom || {}, o = a.getDataset(), s = a.chart.scale,
                            l = a.chart.options.elements.point, u = s.getPointPositionForValue(n, o.data[n]);
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function (n, i) {
                        ...
                        var e = this, n = e.options, i = e.canvas, o = n.maintainAspectRatio && e.aspectRatio || null,
                            s = Math.floor(a.getMaximumWidth(i)), l = Math.floor(o ? s / o : a.getMaximumHeight(i));
                        ...
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var o = n.options, s = a.getValueOrDefault(o.type, n.dtype),
            ...
            e.exports = function (t) {
                function e(t, e, n, a) {
                    ...
                    for (r = 0, o = g.length; r < o; ++r) if (s = g[r], d = n[s], e.hasOwnProperty(s) || (e[s] = d), l = e[s], l !== d && "_" !== s[0]) {
                        if (t.hasOwnProperty(s) || (t[s] = l), u = t[s], c = typeof d, c === typeof u) if ("string" === c) {
                ...
                t.Interaction = {
                    modes: {
                        single: function (t, i) {
                            ...
                            var o = e(n, t), s = r.intersect ? i(t, o) : a(t, o, !1);
                    ...
                    defaults: {}, addBox: function (t, e) {
                        ...
                        function s(t) {
                            ...
                            if (e) if (t.isHorizontal()) {
                                var n = {left: Math.max(R, I), right: Math.max(L, A), top: 0, bottom: 0};
                        ...
                        if (t) {
                            ...
                            var m = e(t.boxes, "left"), v = e(t.boxes, "right"), y = e(t.boxes, "top"),
                                b = e(t.boxes, "bottom"), x = e(t.boxes, "chartArea");
                            n(m, !0), n(v, !1), n(y, !0), n(b, !1);
                            var _ = a - h - f, k = r - g - p, w = _ / 2, M = k / 2, S = (a - w) / (m.length + v.length),
                                D = (r - M) / (y.length + b.length), C = _, P = k, T = [];
                ...
                t.defaults.scale = {
                    ...
                    fit: function () {
                        var t = this, a = t.minSize = {width: 0, height: 0}, r = t.options, o = r.ticks,
                            s = r.scaleLabel, l = r.gridLines, u = r.display, d = t.isHorizontal(), c = n(o),
                        ...
                        if (d ? a.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : a.width = u && l.drawTicks ? f : 0, d ? a.height = u && l.drawTicks ? f : 0 : a.height = t.maxHeight, s.display && u && (d ? a.height += h : a.width += h), o.display && u) {
                            ...
                            if (d) {
                                ...
                                var v = i.toRadians(t.labelRotation), y = Math.cos(v), b = Math.sin(v),
                                    x = b * g + c.size * p + m * p;
                                a.height = Math.min(t.maxHeight, a.height + x), t.ctx.font = c.font;
                                var _ = t.ticks[0], k = e(t.ctx, _, c.font), w = t.ticks[t.ticks.length - 1],
                                    M = e(t.ctx, w, c.font);
                    ...
                    draw: function (e) {
                        ...
                        if (r.display) {
                            ...
                            var m = i.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d),
                                ...
                                b = i.getValueOrDefault(h.fontColor, u.defaultFontColor), x = n(h),
                                _ = i.toRadians(a.labelRotation), k = Math.cos(_), w = a.longestLabelWidth * k;
                            l.fillStyle = m;
                            var M = [];
                            if (p) {
                                if (o = !1, (w + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((w + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), s && a.ticks.length > s) for (; !o || a.ticks.length / (o || 1) > s;) o || (o = 1), o += 1;
                                g || (o = !1)
                            }
                            ...
                            if (i.each(a.ticks, function (t, n) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!l || s) && void 0 !== t && null !== t) {
                                        ...
                                        var b, x, k, w, T, I, A, F, O, R, L = "middle", V = "middle";
                                        if (p) {
                                            ...
                                            var Y, z = "left" === r.position, N = d.padding;
                            ...
                            if (c.drawBorder) {
                                ...
                                var O = a.left, R = a.right, L = a.top, V = a.bottom, W = i.aliasPixel(l.lineWidth);
                    ...
                    generators: {
                        linear: function (t, n) {
                            ...
                            var i, a, r = [], o = e.getValueOrDefault,
                                s = o(t.min, Math.pow(10, Math.floor(e.log10(n.min)))), l = Math.floor(e.log10(n.max)),
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        var t, i, a, r, o = this, s = o._view, l = o._chart.ctx, u = s.spanGaps,
            ...
            e.exports = function (t) {
                ...
                a.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var n = this._view, o = this._model, s = this._chart.ctx, l = n.pointStyle, u = n.radius,
            ...
            e.exports = function (t) {
                ...
                function s(t, e, n, i, a, s) {
                    var l, u, d, c, h, f, g, p = e.length, m = i.spanGaps, v = [], y = [], b = 0, x = 0;
                ...
                var l = t.defaults, u = t.helpers, d = {
                    dataset: function (t) {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (r, o) {
                        var s, l, u, d, c = (r.data.datasets || []).length, h = o.propagate, f = [];
                ...
                return t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, a = n.options, r = a.labels, o = a.display, s = n.ctx, l = t.defaults.global,
                            u = i.getValueOrDefault, d = u(r.fontSize, l.defaultFontSize),
                            c = u(r.fontStyle, l.defaultFontStyle), h = u(r.fontFamily, l.defaultFontFamily),
                        ...
                        if (m ? (p.width = n.maxWidth, p.height = o ? 10 : 0) : (p.width = o ? 10 : 0, p.height = n.maxHeight), o) if (s.font = f, m) {
                            var v = n.lineWidths = [0], y = n.legendItems.length ? d + r.padding : 0;
                            ...
                            var b = r.padding, x = n.columnWidths = [], _ = r.padding, k = 0, w = 0, M = d + b;
                        ...
                        var n = this, a = n.options, r = a.labels, o = t.defaults.global, s = o.elements.line,
                            l = n.width, u = n.lineWidths;
                        if (a.display) {
                            ...
                            var y = e(r, g), b = n.legendHitBoxes, x = function (e, n, i) {
                                if (!(isNaN(y) || y <= 0)) {
                            ...
                            i.each(n.legendItems, function (t, e) {
                                var i = c.measureText(t.text).width, a = y + g / 2 + i, o = d.x, s = d.y;
                        ...
                        determineDataLimits: function () {
                            ...
                            if (void 0 === d && e.each(o, function (e, n) {
                                ...
                                e.each(o, function (r, o) {
                                    ...
                                    void 0 === c[l] && (c[l] = {positiveValues: [], negativeValues: []});
                                    var u = c[l].positiveValues, d = c[l].negativeValues;
            ...
            e.exports = function (t) {
                ...
                function r(t) {
                    var r, o, s, l = n(t), u = Math.min(t.height / 2, t.width / 2),
                    ...
                    for (r = 0; r < h; r++) {
                        ...
                        var g = t.getIndexAngle(r), p = f.toDegrees(g) % 360, m = a(p, s.x, o.w, 0, 180),
                ...
                function d(t) {
                    ...
                    for (var p = e(t) - 1; p >= 0; p--) {
                        ...
                        if (d.display) {
                            var v = t.getPointPosition(p, c + 5), y = a(d.fontColor, g.defaultFontColor);
                            i.font = h.font, i.fillStyle = y;
                            var b = t.getIndexAngle(p), x = f.toDegrees(b);
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                ...
                function n(t, e, n, i) {
                    for (var a, r = Object.keys(s), o = r.length, l = r.indexOf(t); l < o; l++) {
                        a = r[l];
                        var u = s[a], d = u.steps && u.steps[u.steps.length - 1] || u.maxStep;
                ...
                function a(t, e, n, i) {
                    var a = s[n], r = a.size, o = Math.ceil((e - t) / r), l = 1, u = e - t;
                    if (a.steps) for (var d = a.steps.length, c = 0; c < d && o > i; c++) l = a.steps[c], o = Math.ceil(u / (r * l)); else for (; o > i && i > 0;) ++l, o = Math.ceil(u / (r * l));
                    return l
                }
                ...
                var u = t.Scale.extend({
                    initialize: function () {
                        ...
                        var i, r, s = this, l = s.options.time, u = s.dataMin, d = s.dataMax;
                        if (l.min) {
                            var c = e(s, l.min);
                            l.round && c.round(l.round), i = c.valueOf()
                        }
                        l.max && (r = e(s, l.max).valueOf());
                        var h = s.getLabelCapacity(i || u), f = l.unit || n(l.minUnit, i || u, r || d, h);
                        ...
                        }, {min: u, max: d}), s.max = o.max(s.ticks), s.min = o.min(s.ticks)
                        ...
                        var n = this, i = n.options.ticks, a = n.ctx.measureText(e).width,
                            r = Math.cos(o.toRadians(i.maxRotation)), s = Math.sin(o.toRadians(i.maxRotation)),
